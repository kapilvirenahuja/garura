...
Determine branch pattern using: `branch-patterns.md`

Determine commit types from commit messages using: `skills/memory/commit-categories.md`

### 3. Load Rules

Load quality rules from: `quality-rules.md`
