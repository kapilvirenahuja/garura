...
**Triggers:** `**/agents/**/*.md`, `agents/*.md`

| ID | Priority | Item | Verification |
|----|----------|------|--------------|
| `agent-frontmatter` | must-have | Agent has valid frontmatter | Check: name, description |
...
**Triggers:** `**/skills/**/*.md`, `skills/**/SKILL.md`

| ID | Priority | Item | Verification |
|----|----------|------|--------------|
| `skill-frontmatter` | must-have | Skill has valid frontmatter | Check: name, description |
...
### When: Command Definitions Changed

**Triggers:** `**/commands/**/*.md`, `commands/*.md`

| ID | Priority | Item | Verification |
|----|----------|------|--------------|
| `command-frontmatter` | must-have | Command has valid frontmatter | Check: name, description |
| `command-workflow` | must-have | Command defines workflow | Check for ## Workflow section |
| `command-checkpoint` | must-have | Command defines checkpoint behavior | Check for checkpoint in workflow |
...
**Triggers:** `*.yaml`, `*.yml`, `*.json`

| ID | Priority | Item | Verification |
|----|----------|------|--------------|
| `config-valid` | must-have | Configuration syntax valid | Automated: YAML/JSON lint |
