...
**Note:** Task tool is not listed in frontmatter `tools:` but task graph participation is documented in behavior. Minor inconsistency — does not affect runtime since recipe manages task status.
