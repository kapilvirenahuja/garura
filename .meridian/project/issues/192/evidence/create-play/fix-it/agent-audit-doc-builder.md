...
**Note:** Task tool not in frontmatter `tools:` list but task graph participation is explicitly documented. Minor inconsistency — play handles task status for sub-agents at runtime.
