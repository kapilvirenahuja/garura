# plan-roadmap Recipe Review Report

**Recipe:** plan-roadmap
**Intent:** `core/components/recipes/plan-roadmap/reference/intent.yaml`
**SKILL.md:** `core/components/recipes/plan-roadmap/SKILL.md`
**Reviewed:** 2026-03-25
**Mode:** read-only diagnostic (`/create-recipe --review`)
...
| Agent | Role in Recipe | Exists | Result |
|-------|----------------|--------|--------|
...
|-----------|--------|---------------|--------|--------|
| `templates/checkpoint.md` | SKILL.md Step 5 | `core/components/recipes/plan-roadmap/templates/checkpoint.md` | ✓ | PASS |
| `templates/approval-prompt.md` | SKILL.md Step 5 | `core/components/recipes/plan-roadmap/templates/approval-prompt.md` | ✓ | PASS |
| `templates/final-report.md` | SKILL.md Step 8 | `core/components/recipes/plan-roadmap/templates/final-report.md` | ✓ | PASS |
...
- **Remove F6** (or mark it as N/A): The engineering view is no longer an output of this recipe. Engineering detail now lives in `tech.yaml` produced by `/prepare-implementation`.
...
After updating intent.yaml, re-run `/create-recipe --rebake plan-roadmap` to recompile.
