# Recipe Analysis: discover-product (rebake)

**Mode:** Rebake
**Intent path:** `core/components/recipes/discover-product/reference/intent.yaml`
...
Rebake of an existing recipe. Identity preserved:
...
Prior compiled recipe included a `doc-builder` dispatch at Step 4 (Generate
...
context-isolated validator, and a recipe-owned pre-lock gate. No L1 chaining.
