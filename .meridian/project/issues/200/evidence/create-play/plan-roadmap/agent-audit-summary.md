...
All agents audited against P1-P11 in prior compilation cycles and found PASS. doc-builder REMOVED from play (briefs opt-in per ADR — not mandated by intent.yaml).
