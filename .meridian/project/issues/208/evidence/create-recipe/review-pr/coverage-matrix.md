...
|---|---|---|---|---|
| C1 | constraint | structural | Recipe rule + skill diff scope invariant | Role section + quality-check-scoped contract |
...
| C10 | constraint | structural | Forbidden recipe actions | Role section |
