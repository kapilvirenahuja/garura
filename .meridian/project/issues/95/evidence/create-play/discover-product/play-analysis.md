# Play Analysis: discover-product
...
### Play → Phases → Steps → Agent Dispatches
...
| DRAFT/Checkpoint | Step 4 — Write Checkpoint | play | — | draft-checkpoint |
| DRAFT/Evidence | Step 5 — Write Evidence | play | — | draft-evidence |
| VALIDATE/Execution | Step 1 — Validate Vision | product-strategist | validate-product-vision | validate-vision |
| VALIDATE/Checkpoint | Step 2 — Validation Review | play | — | validate-checkpoint |
| VALIDATE/Evidence | Step 3 — Write Evidence | play | — | validate-evidence |
| LOCK/Execution | Step 1 — Lock Vision | play (0 agent calls) | — | lock-vision |
| LOCK/Evidence | Step 2 — Write Evidence | play | — | lock-evidence |
...
| Play Assignment | Agent Declares Skill | Aligned |
|-------------------|---------------------|---------|
...
- Cause: Intent was modified (removed old C10/F4/F8, renumbered constraints, updated C5) after business-review removal but play was not recompiled.

### Issue 2: Stale "business review" text in compiled play
...
- Actual play behavior: 2 product-strategist calls + 1 doc-builder call = 3 dispatches, 2 distinct agents
...
- This is an agent-level issue, not a play gap, but should be cleaned up.
