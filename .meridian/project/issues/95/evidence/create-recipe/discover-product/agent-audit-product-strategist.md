...
| P5 No Direct User Interaction | PASS | NEVER: "Ask user questions directly — return to caller" and "Use AskUserQuestion tool." Returns `domain_clarification_needed` to recipe for user interaction. |
