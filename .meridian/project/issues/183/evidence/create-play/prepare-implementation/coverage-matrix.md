...
- **Agent budget:** Exempt — heavyweight play, use as many dispatches as needed
- **Domain agents:** 3 (tech-architect, test-engineer, product-strategist)
- **Utility agents:** 2 (doc-builder, repo-orchestrator)
- **Total agent dispatches in compiled play:** 20 (Steps 2–22, not counting inline play steps)
...
| Step 20 | (play inline) | — | Auto-Lock |
| Step 21 | (play inline) | — | Evidence |
| Step 22 | repo-orchestrator | utility | Evidence & Close |

*Steps 0, 1, and 19 are play-inline (no agent dispatch).*  
