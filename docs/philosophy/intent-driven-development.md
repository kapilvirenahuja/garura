...
Every play step that produces work writes an evidence artifact to `.garura/{issue}/evidence/{play-name}/{YYYYMMDD-HHMMSS}.md`. Evidence captures what was done, not how — it records the outcome for the audit trail:
