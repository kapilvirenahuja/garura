...
```
### Step 4 — Report
Write evidence to `.phoenix-os/{issue}/evidence/start-feature/{ts}.md`:
- Mode (NEW / RESUME)
...
**Before:**
```
Write checkpoint artifact to `.phoenix-os/{issue}/checkpoint/start-feature/{ts}.md` with Status: `PENDING_APPROVAL`.
```

**After:**
```
Write checkpoint artifact to `.phoenix-os/{issue}/checkpoint/start-feature/{ts}.md` using `templates/checkpoint.md` with Status: `PENDING_APPROVAL`.
```
...
Write checkpoint artifact to `.phoenix-os/{issue}/checkpoint/start-feature-planning/{ts}.md` using `templates/checkpoint.md` with Status: APPROVED. Do not delegate this write.
```

**After:**
```
### Step 4 — Checkpoint
Write checkpoint artifact to `.phoenix-os/{issue}/checkpoint/start-feature-planning/{ts}.md` using `templates/checkpoint.md` with Status: `PENDING_APPROVAL`.
...
```
### Step 6 — Report
Write evidence to `.phoenix-os/{issue}/evidence/start-feature-planning/{ts}.md`:
- Issue number and title
- Branch created
