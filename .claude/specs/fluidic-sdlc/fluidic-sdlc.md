# Fluidic SDLC — Complete Lifecycle Specification
...
**Intent-sufficiency:** Upstream artifacts enrich, never block. If intent is clear, proceed. If critical context missing, suggest upstream recipe as option — user decides.
