...
- **Agent:** code-builder
- **File:** `core/components/plays/start-planned-feature/SKILL.md`
...
## Task 5: Update play documentation

- **Agent:** code-builder
- **File:** `docs/components/mrd-plays.md`
- **Action:**
  1. Update atomic play structure template to include `intent`, `constraints`, `failure_conditions`
  2. Update high-order play structure template to include same
...
- **Action:**
  1. Run `sync-claude --project` — verify all plays deploy to `.claude/skills/`
  2. Confirm each play loads without error in Claude Code
- **Verification:** Gate 5
- **Parallel:** No
...
- **Agent:** quality-validator (or manual)
- **Action:**
  1. For each play, compare front-matter Three Elements against workflow body
...
- **Agent:** code-builder
- **File:** `docs/adr/009-play-three-elements.md` (new)
