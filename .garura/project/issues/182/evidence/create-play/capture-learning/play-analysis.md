...
The compiled play has ZERO steps for the extraction phase. Constraints C5-C13, failure conditions F6-F11, and scenarios S3-S6 are defined in intent.yaml but have no corresponding compiled steps, evals, or agent contracts.
