...
| C5 | constraint | structural | Play structure | Agent dispatch counts, Intent Assessment |
...
| C9 | constraint | structural | Play structure | Cycle-back logic in VALIDATE |
| C10 | constraint | artifact-verifiable | SE-14 | Step 3 Eval |
| C11 | constraint | structural | Play structure | Domain clarification in Step 1 |
| C12 | constraint | structural | Play structure | Intent Assessment section |
