...
| C5 | constraint | structural | Play structure | Agent dispatch budget |
...
| C9 | constraint | structural | Play structure | Cycle-back logic in Step 7 |
| C10 | constraint | artifact-verifiable | SE-13 | Step 4 Eval |
| C11 | constraint | structural | Play structure | Domain clarification in Step 2 |
| C12 | constraint | structural | Play structure | Intent Assessment in Step 1 |
