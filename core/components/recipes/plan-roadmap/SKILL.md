...
Intent defines constraints (C1-C12), failure conditions (F1-F8), and scenarios (S1-S7).
...
| # | Blocker | Feature | Recommendation |
|---|---------|---------|----------------|
| 1 | {description} | {feature_ref} | {recommendation} |
...
| Field | Value |
|-------|-------|
| intent_hash | sha256:8370cb2e0ca54852e1933e3ba6fdf5fa44059a8e723086d7d8375e0628cf553c |
