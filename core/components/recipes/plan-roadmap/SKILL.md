...
Intent defines constraints (C1-C15), failure conditions (F1-F10), and scenarios (S1-S9).
...
| SCE-6 | Product Manager | PASS/FAIL |
| SCE-7 | Product Manager | PASS/FAIL |
| SCE-8 | Stakeholder | PASS/FAIL |
```
...
| Field | Value |
|-------|-------|
| intent_hash | sha256:b025af84e693d214c87c0a6cde0eb6389a7a75bc41e71fbe036495a445e49804 |
