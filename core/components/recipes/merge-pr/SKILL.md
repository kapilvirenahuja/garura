...
To modify this recipe, update `reference/intent.yaml` and re-run `/create-recipe --bake merge-pr`.
Do NOT edit this file manually — it is a compiled artifact.

**Intent hash guard:** If `sha256(reference/intent.yaml)` does not equal `7b2fde0690f6d64298ee7afdbe9e6fca04044b9283e8079ccc62adc5d9a240fb`, re-bake is required before running.
...
```json
{
  "intent_path": "core/components/recipes/merge-pr/reference/intent.yaml",
  "stm_base": "{stm_base}",
  "stm": {
    "input": {},
    "output": {
