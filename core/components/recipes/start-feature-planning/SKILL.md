...
To modify this recipe, update intent.yaml and re-run `/create-recipe --bake start-feature-planning`.
...
```json
{
  "intent_path": "core/components/recipes/start-feature-planning/reference/intent.yaml",
  "stm_base": "{stm_base}",
  "stm": {
    "input": {
