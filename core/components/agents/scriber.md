...
| `.garura/product/...` | Product planning artifacts (specify-product outputs) |
| `.garura/product/experience/...` | UX / design artifacts (design-exp outputs, post-D1 folder rename from `ux/`) |
| `.garura/product/architecture/...` | Architecture artifacts (build-arch outputs, post-D1 folder rename from `arch/`) |
...
| `.garura/project/issues/{N}/context/...` | Issue-scoped prepare-epic context |
| `.garura/project/issues/{N}/review/...` | Issue-scoped review artifacts |

Underscore-prefixed subdirectories INSIDE the product root are allowed (e.g., `.garura/product/_checkpoints/specify-product/20260414.md` lives at the product root alongside the stage folders and is therefore legal).
