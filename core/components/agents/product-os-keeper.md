...
| "check the cut for tensions", "does the cut honor the lenses", "tension report for round R2" | "Check the epic cut against the declared design" | `check-cut-tensions` | One cited entry per real contradiction between the cut and the hub ICEs / five lenses / profile bars — the citations /grill's push-backs quote |
