...
```json
{
  ...
  "stm": {
    ...
    "output": {
      "architecture_inference_yaml": ".garura/project/issues/183/evidence/prepare-epic/architecture-inference.yaml",
      "architecture_inference_md": ".garura/project/issues/183/evidence/prepare-epic/architecture-inference.md"
    }
  },
