...
Intent defines constraints (C1–C9), failure conditions (F1–F8), and scenarios (S1–S4).
...
**Intent hash guard:** If `sha256(reference/intent.yaml)` does not equal `ef460ada5637a432ae142eca7eec6e995f7bdab45f01b313fbf7ab2cda3e5be5`, rebuild is required before running.
...
| Field | Value |
|-------|-------|
| intent_hash | sha256:ef460ada5637a432ae142eca7eec6e995f7bdab45f01b313fbf7ab2cda3e5be5 |
