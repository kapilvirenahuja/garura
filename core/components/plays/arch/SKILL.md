...
This play was compiled from `reference/intent.yaml` by `/create-play --rebuild arch`.
Intent defines constraints (C1-C19), failure conditions (F1-F19), and scenarios (S1-S7).
To modify this play, update intent.yaml and re-run `/create-play --rebuild arch`.
...
| compiled_by | `/create-play --rebuild arch` |
