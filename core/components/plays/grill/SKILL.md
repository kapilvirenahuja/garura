...
constraints (C1–C13) and failure conditions (F1–F14); the expectation defines success
...
| step_evals | 15 (SE-1…SE-15; one per failure condition F1–F14, plus SE-11 for C10) |
