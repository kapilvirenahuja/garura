...
| F15 | an epic at the write-gate has no `surface` block, or a surface defaulted to a non-user-facing type with no human confirmation | declare the surface from the slice intent and the epic's user_check per surface-contract.md, put it to the human at the checkpoint, and write it; block the cut until every epic carries a confirmed surface | human |
...
| Field | Value |
|-------|-------|
| fingerprint | sha256:3176fa159e690145cb51c275929bf516788047de9cb73a50b135a261698b19e7 (of `reference/ice.md`) |
