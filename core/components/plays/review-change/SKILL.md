...
(#443 redesign; #467 Batch C gate ruling; #484 scripted chain). Intent defines constraints (C1–C10) and failure
conditions (F1–F11); the expectation defines success scenarios (S1–S5), a Done means
...
| Field | Value |
|-------|-------|
| fingerprint | sha256:8120982d293cd23857b3dd0e5962219c114e2298ccc7fb269a1e45bc8d11f528 (of `reference/ice.md`) |
...
| recovery_entries | 11 (one per failure condition; F8 hands to the human gate, the rest autonomous) |
