...
| `intent-schema.yaml` | Canonical intent.yaml contract — fields produced by intent-crafter and consumed by intent-resolver / create-recipe | intent-crafter, intent-resolver, create-recipe |
...
> Brief presentation rules previously in `brief-principles.md` are now `docs/design/briefs.md`. Brief HTML/CSS/JS templates live with the `briefs` recipe at `core/components/recipes/briefs/templates/`.
