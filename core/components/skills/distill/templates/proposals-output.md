...
proposals:                                 # Maps to: reconciliation-proposals.yaml `proposals[]`
  - target_path: "{path to product LTM artifact to enrich}"
    # Example: .garura/product/garura/research/knowledge-management.md
    # Example: .garura/product/garura/architecture/design-patterns.yaml
...
proposals:
  - target_path: ".garura/product/garura/research/knowledge-management.md"
...
proposals:
  - target_path: ".garura/product/garura/research/agent-design.md"
    section: "Experiential"
    proposed_content: |
      scenarios_observed:
  ...
  - target_path: ".garura/product/garura/architecture/design-patterns.yaml"
