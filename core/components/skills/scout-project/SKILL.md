...
1. **Discover project structure.** Glob the project root for key files. Not all projects have the same structure — adapt to what exists:
   ...
   | `.meridian/project/product/*/product.yaml` | Product definition — problem, users, goals, status | High — read |
   | `.meridian/project/product/*/roadmap.yaml` | Roadmap thesis, horizon sequencing, feasibility | High — read |
   | `.meridian/project/product/*/features.yaml` | Features, invariants, scope, IDD fields | High — read |
   | `.meridian/project/product/*/architecture.yaml` | System architecture, stack, platforms, agentic design | High — read |
   | `.meridian/project/product/*/tech.yaml` | Low-level design, project structure, components, libraries | High — read |
   | `.meridian/project/product/*/scenarios.yaml` | Verification scenarios, feature gates, coverage summary | High — read |
   | `.meridian/project/product/*/plan.yaml` | Execution order, scope items, exit gates, scenario gates | High — read |
